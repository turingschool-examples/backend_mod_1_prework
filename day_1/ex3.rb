...
#writes letters & characters included in string,
#as well as performing the computation inside
#braces or brackets.
puts "Hens #{25 + 30 / 6}"
#writes letters & characters included in string,
#as well as performing the computation inside
...
#interpret as integers to be computed.no braces or brackets required as
...
#and boolean result as less-than character is used after octothorpe
...
# [X] 3. PEMDAS is less accurate way of OOO. PE(M&D)(A&S). I'm not sure where a
        #modulus fits into this though as I did struggle to solve this even with
        #using google. I did not do youtube though. That may have been a better
        #resource. Trying to control my rabbit-holes.
