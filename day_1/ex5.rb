...
# Change all the variables so there is no my_ in front of each one. Make
...
puts "#{my_name} is #{height_cm} centimeters tall."
puts "#{my_name} is #{weight_kg} kilograms light."
