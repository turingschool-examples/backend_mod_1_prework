...
weather = $stdin.gets.chomp
  ...
  if weather == '1'
    p "You should bring sunscreen with you!"
  elsif weather == '2'
    p "You should bring an umbrella!"
  elsif weather == '3'
    p "You should wear a coat!"
  elsif weather == '4'
...
puts "Let's see. How many quarters do you have?"
...
puts "Let's see if we have the goods to make a pizza!"
puts "How many cups of flour do you have?"

print "> "
cups_of_flour = $stdin.gets.chomp

puts "true or false, do you have sauce?"
print "> "
