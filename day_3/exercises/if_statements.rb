...
if num_quarters < 2 && num_quarters != 0
  puts "I don't have enough money for a gumball"
elsif num_quarters >= 2
  puts "I have enough money for a gumball"
else
  puts "I need to get change to get a gumball."
end
...
# Ask user how many cups_of_flour they have
puts "How many cups of flour do you have?"
print "> "

# Get user input for cups_of_flour
cups_of_flour = $stdin.gets.chomp.to_i

# Ask user if they have any sauce
puts "Do you have any sauce?"
print "Y or N > "

# Get user input for has_sauce
has_sauce = gets[0].downcase == "y"

if cups_of_flour >= 2 && has_sauce == true
  puts "I can make pizza."
elsif cups_of_flour < 2 && has_sauce == true
  puts "I cannot make pizza. I need more flour"
elsif cups_of_flour >= 2 && has_sauce == false
  puts "I cannot make pizza. I need sauce."
else
  puts "Pizza sounds good! I don't have the ingredients to make it.
