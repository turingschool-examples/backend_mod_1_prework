...
states = ["disaster", "disarray", "the union"] # I couldn't help myself
p states

# Write code below that will print an array of foods. Store the array in a variable.
foods = ["Ice cream", "Chocolate ice cream", "Cookie dough ice cream"]
p foods
...
animals.pop
p animals
# unclear whether "result" means element removed or the mutated array. I chose
# the latter
