...
print "A pizza requires at least 2 cups of flour and sauce."
puts "You have #{cups_of_flour} cups of flour on hand."
puts "Do you have sauce? #{has_sauce}"

if cups_of_flour >= 2 && has_sauce
  puts "You can make a pizza!"
elsif cups_of_flour < 2 && has_sauce
  puts "Please get more flour"
elsif cups_of_flour >= 2 && !has_sauce
  puts "Please get more sauce"
else
  puts "Make a burger"
end
