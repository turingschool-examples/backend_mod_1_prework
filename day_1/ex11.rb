...
## STUDY DRILLS
  # 1. Google gets.chomp, and find out what it is.
    # According to a codeacademy user, the gets part, is a method that asks the user to input something, while the chomp part is a method that removes the blank line that is automatically created by gets after the input
