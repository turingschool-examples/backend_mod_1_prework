...
if cups_of_flour == 1 && has_sauce == true
  ...
  puts "I can make 2 pizzas."
else cups_of_flour == 5 && has_sauce == false
  puts "I cannot make pizza."
end
# I changed the output for line 78 to discriminate the functionality between line 75 and 77.
# Since the variable = 2 and variable = 3 have the same output you couldn't necessarily prove that the coding was correct.
