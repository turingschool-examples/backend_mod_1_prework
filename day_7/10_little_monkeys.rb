...
# First with just 10 monkeys
# Bonus: run for any number of monkeys?
#require 'pry'

# Method to convert int to text version
...
# Input number of monkeys to output
puts "Please enter how many monkeys to output: "
