...
2. Work through the following lessons. Any files that you create while working can be kept in today's `exercises` directory.
...
3. Work through the exercise files in the day_2/exercises directory.  Complete them in this order:
    1. arrays
    2. iteration

4. Answer the questions in the questions.md file in the day_2 directory.
...
2. `$ git add day_2/questions.md`
3. Use `git add day_2/<filename>` to add all additional files that you created today
