...
## TASK
  ...
  # Type the following into a single file named ex1.rb in your text editor
  #(in this case, it's Atom)
puts "Hello World!"
puts "Hello Again"
...
## Points to keep in mind:
  # Don't type the line numbers (example: this is line 14)
  # Add 'puts' at the beginning of a line
...
## Running your script in the terminal:
  ...
  # If an error occurs, you will see something like this: ex1.rb:3: syntax error, unexpected ...
  # This tells us that the file has an error in line 3, it is a syntax error, then
  # some programmer jargon, and it prints out the line
...
puts "The '#' at the beginning of a line, tells the computer not to run it because it's Comment, not code."
  # "An "octothorpe" is also called a "pound", "hash", "mesh", or any number
  # of names. Pick the one that makes you chill out."
