...
# creates a variable that is a string
binary = "binary"
# creates a variable that is a string
do_not = "don't"
#creates a variable that is a string with two variables inside the string
...
# prints a string with a variable in it
puts "I said: #{x}."
puts "I also said:  '#{y}'."
...
# creates variable that is a string
e = 'a string with a right side.'

# prints the variables w and e concatenated
puts w + e
