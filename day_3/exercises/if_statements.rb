...
print "What's the weather look like today? (e.g., sunny, rainy, snowy, icy) "
weather = gets.chomp

if weather == 'sunny'
  p "You might want to apply sunscreen."
elsif weather == 'rainy'
  p "Better bring an umbrella!"
elsif weather == 'snowy'
  p "Better wear a heavy coat!"
elsif weather == 'icy'
  p "You're going to need yak traks to walk!"
else
  p "You're good to go!"
end
...
print "How many quarters do I have? "
...
print "How many cups of flour do I have in the pantry? "
cups_of_flour = gets.chomp.to_i
print "Do I have sauce? (true or false) "
has_sauce = gets.chomp

if cups_of_flour >= 2 && has_sauce == "true"
  p "YES! I can make pizza!!!"
else
  p "I don't have enough ingredients to make pizza :( This is a tragedy."
end
