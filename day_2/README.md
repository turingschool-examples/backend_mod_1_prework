...
1. Define .methods for Arrays in the following lessons
   - [x] [Arrays](http://tutorials.jumpstartlab.com/projects/ruby_in_100_minutes.html#7.-arrays)
   - [x] [Ruby docs for Arrays](https://ruby-doc.org/core-2.4.1/Array.html).
   - [x] Create a file in your day_2 directory called `array_methods.md` and describe what each method does in your own words.
