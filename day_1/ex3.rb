...
# < less-than - if the first number is less than the second number, it prints out true, otherwise, it prints out false
# > greater-than - if the first number is greater than the second number, it prints out true, otherwise, it prints out false
# <= less-than-equal - if the first number is less than or equal to the second number, it prints out true, otherwise, it prints out false
# >= greater-than-equal - if the first number is greater than  or equal to the second number, it prints out true, otherwise, it prints out false
...
# This multiplies 25 by 3, then asigns the result of that as a percentage, multiplies that by 4, then subtracts the result from 100
puts "Roosters #{100.0 - 25.0 * 3.0 % 4.0}"

# This creates a string
puts "Now I will count the eggs:"

# This asigns the 4 as a percentage and multiplies it by 2, while at the same time dividing 1 by 4, then it adds and subtracts from left to right
puts 3.0 + 2.0 + 1.0 - 5.0 + 4.0 % 2.0 - 1.0 / 4.0 + 6.0

# This creates a string
puts "Is it true that 3 + 2 < 5 - 7?"

# This performs the operations (adding 3 and 2, and subtracting 7 from 5), and using a boolean, prints the answer
