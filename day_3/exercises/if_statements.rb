...
if num_quarters == 0
  puts "I don't have enough money for a gumballs"
  ...
  puts "I have enough money for something other than a gumball"
end
...
if cups_of_flour == 1 && has_sauce == true
  ...
  puts "I can make many pizzas."
else
  puts "Tell me how many pizzas you want."
end
