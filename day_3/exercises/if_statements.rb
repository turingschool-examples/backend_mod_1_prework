...
p "The weather is #{weather = weather.shuffle.first}. You'll need: "
...
#Made it so weather is randomly assigned every time the file is run.
#Probably should re-do the wording of some of the if/elsif/else results.
