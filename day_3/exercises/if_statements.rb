...
puts "you have #{cups_of_flour} cups of flour"
puts "you have sauce? #{has_sauce}!"

if cups_of_flour >= 2 && has_sauce == true
  puts "You have enough ingredients to make a pizza!"
elsif cups_of_flour >= 2 && has_sauce != true
  puts "You need sauce to make a pizza!"
elsif cups_of_flour < 2 && has_sauce == true
  puts "You need more flour to make a pizza!"
else
  puts "You need sauce and flour to make a pizza!"
end
