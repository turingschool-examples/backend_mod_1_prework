...
dobbys_warning = "Harry Potter must not return to Hogwarts!"
p dobbys_warning
...
students = 22
p students
p "Adding 2 to the total number of students results in #{students + 2}"

# Write the code below to subract 2 students from the `students` variable and
# print the result:
students = 22
p students
p "Subtracting 2 from the total number of students results in #{students - 2}"
