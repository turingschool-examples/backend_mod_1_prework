#Remember again. Ruby files are run as ruby <filename>.rb in the terminal. irb
#is for interacting with code by putting in user input.
...
# 3. [X]The quickest way to comment out multiple lines of code is to
#       highlight cmd ?
