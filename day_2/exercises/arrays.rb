...
states = ["Maine", "New Hampshire", "Vermont", "Pennsylvania", "New York", "Connecticut", "Rhode Island", "Maryland", "Delaware", "Massachusetts", "Virginia", "North Carolina", "South Carolina", "Georgia"]
p states

# Write code below that will print an array of foods. Store the array in a variable.
food = ['soup', 'salad', 'sandwich', 'omelette', 'rice']
