...
# then prints that array:
states = ["Colorado", "Iowa", "Pennsylvania", "Oregon"]
p states

# Write code that stores an array of foods in a variable,
# then prints that array:
foods = ["sushi", "ramen", "edamame", "miso soup"]
p foods
...
# When you say "and prints the result," do you mean that as in how pop prints
# the item that was removed, or prints the entire array again except for the last?
