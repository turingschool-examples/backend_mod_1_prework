...
num_quarters = num_quarters.to_f

if num_quarters > 0.5 || num_quarters == 0.5
  puts "I have enough money for a gumball"
elsif num_quarters < 0.5
...
if has_sauce == "y"
  has_sauce = true
    ...
    cups_of_flour = gets.chomp.to_i
      ...
      if cups_of_flour < 1 || cups_of_flour == 1
        puts "I cannot make pizza"
      elsif cups_of_flour == 2 || cups_of_flour > 2
