...
# runs a calculation and interpolates the answer in a puts statement
puts "Hens #{25.0+30.0/6.0}"
# runs a calculation and int. the answer in a puts statement
puts "Roosters #{100.0-25.0*3.0%4.0}"
# simple puts statement for a string
puts "Now I will count the eggs:"
# performs a calculation and puts the answer.
# % finds the remainder of the division problem
