...
# this one took me extra time because I didn't realize the greater than/less
# than can only be written as >= and <=, I had it flipped which looked like =>
# and =<
