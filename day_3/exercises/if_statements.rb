...
puts "What is the weather like? (sunny, rainy, snowy, icy)"
print "> "
...
puts "---------------"
puts "You want a gumball. How many quarters do you have?"
print "> "
...
puts "--------------"
puts "Time to make a pizza! How many cups of flour do you have?"
print "> "
cups_of_flour = $stdin.gets.chomp.to_i
puts "What about sauce, do you have some sauce? (Y/N)"
tf_sauce = $stdin.gets.chomp
