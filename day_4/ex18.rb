...
## COMMON Qs
  #Q. "What's allowed for a method name?"
  #A. Like variable names, letters, numbers and underscores can be a part of
    # the method name, as long as it doesn't start with a number.

  #Q. "What does the * in *args do?"
  #A. It tells Ruby to take all the arguments to the method and put them
    # in a list in args
