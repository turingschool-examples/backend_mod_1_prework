# Using a hash, I can assign numbers to their names
numbers_named = {10 => "ten", 9 => "nine", 8 => "eight", 7 => "seven", 6 => "six", 5 => "five", 4 => "four", 3 => "three", 2 => "two", 1 => "one"}

# Next, I create a range for my numbers which in this case is 1-10
# I then use the reverse.each method as it reverses the order of the numbers
# in my range
# I then puts each line of the rhyme one by one, with the first line
